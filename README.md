...
Ce projet est une version personnalisée d'[AccesSlide](http://www.accesslide.net/), un framework pour réaliser des présentations accessibles en HTML5-CSS3-JS.

Ce fichier README est une adaptation du [fichier README du dépôt d'origine](https://github.com/access42/AccesSlide/blob/master/READMEFR.md), allégé en fonction des modifications apportées par rapport au projet initial.
